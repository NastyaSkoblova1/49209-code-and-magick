...
(function() {
  var reviews = [{
   ...
   'review_usefulness': 10,
    ...
    var getReviewElement = function(reviews) {
      ...
      reviewAuthor.textContent = reviews.author.name;
      reviewRating.classList.add('review-rating-' + valueRatingClass[reviews.rating - 1]);
      reviewText.textContent = reviews.description;

      var authorImage = new Image();
      authorImage.onload = function() {
        reviewAuthor.src = reviews.author.picture;
