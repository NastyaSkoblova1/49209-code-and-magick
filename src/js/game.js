    ...
    _drawPauseScreen: function() {
      ...
      switch (this.state.currentStatus) {
        case Verdict.WIN:
          ...
          this.ctx.lineTo(545, 70);
          this.ctx.lineTo(510, 210);
          ...
          textStatus = ['Это успех!', 'Я куда-то попал.'];
          y = 120;
        ...
        case Verdict.FAIL:
          ...
          textStatus = ['Что-то пошло не так', 'Я никуда не попал.'];
          y = 120;
          for (i = 0; i < textStatus.length; i++) {
            this.ctx.fillText(textStatus[i], x, y);
            y += 26;
        ...
        case Verdict.PAUSE:
          ...
          textStatus = ['Я отдыхаю.', 'Чтобы продолжить игру', 'нажми пробел.'];
          y = 120;
          for (i = 0; i < textStatus.length; i++) {
            this.ctx.fillText(textStatus[i], x, y);
            y += 26;
        ...
        case Verdict.INTRO:
          ...
          textStatus = ['Привет! Я крутой маг.', 'Умею перемещаться и летать,', 'а ещё стрелять файрболами.'];
          y = 105;
          for (i = 0; i < textStatus.length; i++) {
            this.ctx.fillText(textStatus[i], x, y);
            y += 26;
